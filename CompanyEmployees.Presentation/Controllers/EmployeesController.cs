...
namespace CompanyEmployees.Presentation.Controllers
{
    ...
    public class EmployeesController : ControllerBase
    {
        ...
        {
            if (patchDoc is null)
                return BadRequest("patchDoc objects sent from client is null.");
            ...
            await _service.EmployeeService.SaveChangesForPathAsync(result.employeeToPatch, result.employeeEntity);
