...
namespace Service
{
    internal sealed class CompanyService : ICompanyService
    {
        ...
        public async Task<IEnumerable<CompanyDto>> GetAllCompaniesAsync(bool trackChnages)
        {
            var companies = await _repository.Company.GetAllCompaniesAsync(trackChnages);
